...
DEFAULT_MODEL_CONF = float(os.getenv("CONF_POTHOLE", os.getenv("DEFAULT_MODEL_CONFIDENCE", "0.15")))
DEFAULT_DET_CONF = float(os.getenv("DET_CONF_POTHOLE", os.getenv("DEFAULT_DETECTION_CONFIDENCE", "0.15")))
